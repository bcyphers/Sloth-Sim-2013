...
public class b2Body
{
	...
	*/
	...
	public var m_velocityLimiter:Function = null;
	
	/**
	* Set a cap on the linear velocity of the center of mass.
	* @param v the new linear velocity of the center of mass.
	*/
	public function SetLinearVelocityFunction(f:Function) : void {
		if ( m_type == b2_staticBody )
		{
			return;
		}
	...
	/**
	* Get the linear velocity limiting function of the center of mass.
	* @return the linear velocity limiting function of the center of mass.
	*/
	public function GetLinearVelocityFunction() : Function {
		return m_velocityLimiter;
	}
	
	/**
	* Apply the linear velocity limiting function to the current velocity.
	* @return the new linear velocity.
	*/
	public function ApplyLinearVelocityFunction() : b2Vec2 {
		if (m_velocityLimiter != null)
			return m_velocityLimiter(this.m_linearVelocity);
		return m_linearVelocity;
	}
